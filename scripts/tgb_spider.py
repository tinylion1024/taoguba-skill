...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("fetch_corpus.log"), logging.StreamHandler(sys.stdout)],
)
...
def parse_args():
    ...
    parser.add_argument("--base-url", default="https://www.tgb.cn/dianzan", help="列表页基础URL（不含分页）")
    ...
    parser.add_argument("--out-dir", default="./data", help="输出根目录（会自动创建 corpus 子目录）")
